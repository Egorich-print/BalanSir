...
pub fn create_router(state: Arc<ApiState>) -> Router {
    Router::new()
        ...
        .route("/system", get(subsystems::get_system))
        ...
        .route("/dpi/pause", post(subsystems::set_dpi_paused))
        ...
        .route("/vpn/pool", get(subsystems::get_vpn_pool))
        .route("/vpn/pause", post(subsystems::set_vpn_paused))
